...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/libcusolver-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/libcusolver-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add libcusolver libcusolver-dev libcusolver-static
# for installing globally
pixi global install libcusolver libcusolver-dev libcusolver-static
```
...
It is possible to list all of the versions of `libcusolver` available on your platform:
...
```
pixi search libcusolver --channel conda-forge
```
